"""
Django settings for defUserModelproj project.
...
SECRET_KEY = 'django-insecure-7ew!ca0ch)_2=iobm&luo(6@fkxe(6sxf28ltojg0nmrk06q^5'
...
ROOT_URLCONF = 'defUserModelproj.urls'
...
WSGI_APPLICATION = 'defUserModelproj.wsgi.application'
